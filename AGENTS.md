...
- Không tự chuyển URL theo ngôn ngữ trình duyệt, header hoặc JavaScript. Mỗi URL Việt - Anh phải trả về `200`, giữ canonical của chính nó và cho người đọc đổi ngôn ngữ qua link rõ ràng. Chuyển hướng tự động có thể khiến Googlebot ghi nhận sai redirect hoặc canonical.
