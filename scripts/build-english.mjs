...
const translations = {
  ...
  "01 bài": "01 post",
  "02 bài": "02 posts",
  "Dịch ngược - Bảo mật": "Reverse engineering - Security",
  "Zalo PC mã hóa bản backup để bảo vệ ai?": "Who does Zalo PC backup encryption protect?",
  "13 phút": "13 min",
  "3 phút": "3 min",
  ...
  "Một vài mảnh ghép.": "A few pieces.",
  "Trang này là góc để mình cất bài viết, dự án, dấu mốc và mấy thứ học được trong lúc đi từ Minecraft tới code.": "This site is where I keep writing, projects, milestones, and the things I learned while going from Minecraft into code.",
  "Mấy mốc cơ bản.": "The basic marks.",
  "Tên": "Name",
  "Nguyễn Thành Nhân": "Nguyễn Thành Nhân",
  "Liên hệ": "Contact",
  "Phần này mới là đường đi.": "This part is closer to the path.",
  "Minecraft là mốc mở đầu rõ nhất. Từ khoảng năm 2015, mình xem, tải và chơi Minecraft Pocket Edition, rồi lần mò qua server, plugin, PocketMine-MP, port, backup dữ liệu, lỗi console và mấy file config nhìn tưởng nhỏ mà sửa cả đêm không xong.": "Minecraft is the clearest starting point. Around 2015, I watched, downloaded, and played Minecraft Pocket Edition, then wandered into servers, plugins, PocketMine-MP, ports, backups, console errors, and config files that looked small but could still eat an entire night.",
  "PocketMine-MP không chỉ là một phần của Minecraft với mình. Nó là chỗ mình học cách đọc lỗi, sửa code, việt hóa plugin, lưu lại tài nguyên cũ và dần dần biết mình muốn đi theo Công nghệ thông tin. Năm 2019, mình lập group PocketMine-MP Việt Nam, không lớn lắm, nhưng vẫn còn đó cho những người vẫn nhớ hoặc vẫn cần một góc về server Bedrock.": "PocketMine-MP is not just a Minecraft detail for me. It is where I learned to read errors, edit code, translate plugins, preserve old resources, and slowly realized that Information Technology was the path I wanted. In 2019, I started the PocketMine-MP Vietnam group. It is not huge, but it is still there for people who remember or still need a corner for Bedrock servers.",
  "Mình cũng có hàng trăm repo và khá nhiều tổ chức trên GitHub. Có repo nhỏ để thử ý tưởng, có repo để lưu trữ, có repo mở ra cho người khác dùng, có repo chỉ để nhắc mình rằng một thứ từng tồn tại. Nếu muốn xem kỹ hơn,": "I also keep hundreds of repositories and quite a few GitHub organizations. Some repos are tiny experiments, some are archives, some are open for others to use, and some simply remind me that something once existed. If you want the longer version,",
  "là chỗ mình gom phần đó lại.": "is where I gather that part.",
  "Discord của mình là NhanAZ nếu bạn muốn nhắn trực tiếp. Nếu ở Việt Nam, bạn có thể nhắn qua": "My Discord is NhanAZ if you want to message me directly. If you are in Vietnam, you can use",
  "thường mình trả lời ở đó nhanh nhất. Riêng tư hơn thì": "where I usually reply fastest. For something more private,",
  "Riêng tư hơn thì": "For something more private,",
  "cũng được.": "works too.",
  "Mấy câu hỏi chưa có đáy": "Questions with no bottom",
  "Mình hay hỏi “tại sao”, rồi tự làm mọi thứ phức tạp hơn.": "I ask “why”, then make everything more complicated.",
  "Mình bị hút vào những thứ như triết học, đạo đức, ý nghĩa sự sống, tự do ý chí, thời gian, lượng tử, hố đen, UFO và chuyện ngoài Trái Đất. Không phải lúc nào cũng có đáp án gọn, nhưng mấy câu hỏi đó khiến mình còn muốn đọc, nhìn, thử và hỏi tiếp.": "I am drawn to things like philosophy, ethics, the meaning of life, free will, time, quantum physics, black holes, UFOs, and whatever might exist beyond Earth. Not every question has a neat answer, but they keep me reading, looking, testing, and asking again.",
  "là chỗ mình để phần dài hơn.": "is where I keep the longer version.",
