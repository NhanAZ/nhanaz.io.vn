...
This personal website currently has no OAuth, MCP server, webhook, user account, or endpoint that changes content. The [OpenAPI document](https://nhanaz.io.vn/openapi.json) describes read-only GET retrieval of the static resources above and a small public page-view counter at `/api/views`. For source and coding-agent rules, use the [GitHub repository](https://github.com/NhanAZ/nhanaz.io.vn) and its [AGENTS.md](https://github.com/NhanAZ/nhanaz.io.vn/blob/main/AGENTS.md).
