...
This personal website currently has no public API, OAuth, MCP server, webhook, user account, or endpoint that changes data. For source and coding-agent rules, use the [GitHub repository](https://github.com/NhanAZ/nhanaz.io.vn) and its [AGENTS.md](https://github.com/NhanAZ/nhanaz.io.vn/blob/main/AGENTS.md).
