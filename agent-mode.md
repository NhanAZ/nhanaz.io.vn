...
There is no user account, OAuth flow, webhook, content-writing endpoint, checkout, or private data surface. The site offers read-only MCP at [/mcp](https://nhanaz.io.vn/mcp), A2A at [/a2a](https://nhanaz.io.vn/a2a), A2UI at [/a2ui](https://nhanaz.io.vn/a2ui), and NLWeb search at [/ask](https://nhanaz.io.vn/ask). Treat personal memories and criticism as first-person source material, and verify externally checkable claims against the canonical article and its links.
